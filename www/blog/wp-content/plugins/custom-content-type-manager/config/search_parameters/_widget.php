...
pop up when you create a Summarize Posts widget. The available
...
// CCTM::$search_by[] = 'paginate'; // Do not enable this: chaos would result if multiple widgets tried to paginate multiple result sets.
